...
通过 Anthropic 兼容 API 将后台任务路由到多个 AI 供应商（DeepSeek、智谱 GLM、MiniMax、Kimi、Aliyun、Ollama、OpenAI），同时充分利用 Claude Code 的原生能力。

## 特性

- **多供应商 MCP 服务器** - 支持 DeepSeek、智谱 GLM、MiniMax、Kimi、Aliyun、Ollama、OpenAI 的后台任务执行
