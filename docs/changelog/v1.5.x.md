...
- **`/omc-clear` Slash Command**: AI-powered selective memory cleanup
...
- **`/omc-summary` Slash Command**: Date-range memory consolidation into timeline
  ...
  - Supports `days`, `scope` arguments (e.g., `/omc-summary 14 project`)

- **`clear_memories` MCP Tool**: Backend for `/omc-clear`
...
- **`summarize_memories` MCP Tool**: Backend for `/omc-summary`
