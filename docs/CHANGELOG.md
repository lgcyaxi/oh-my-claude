...
- **CC Session Exits in IDE Terminals** — Fixed `omc cc` immediately showing `[exited]` in Cursor/VSCode. Switched tmux to detach-then-attach pattern and stripped inherited Claude env vars.
