...
/**
 * Ensure .sisyphus/plans directory exists
 */
export function ensurePlansDir(directory: string): string {
  const plansDir = join(directory, PROMETHEUS_PLANS_DIR)
  if (!existsSync(plansDir)) {
...
/**
 * Ensure .sisyphus/drafts directory exists
 */
export function ensureDraftsDir(directory: string): string {
  const draftsDir = join(directory, ".sisyphus/drafts")
