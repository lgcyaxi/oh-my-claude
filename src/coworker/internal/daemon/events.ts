...
/** Payload emitted when the daemon observes task-level coworker activity. */
export interface DaemonActivityEvent {
	id: RequestId | null;
	event: CoworkerTaskEvent;
}
...
/**
 * Typed event bus for daemon communication.
 *
...
export class DaemonEventBus {
	...
	emit<K extends keyof AIDaemonEventMap>(
		event: K,
