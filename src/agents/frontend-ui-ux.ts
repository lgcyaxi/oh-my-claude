/**
 * Frontend UI/UX Engineer - Visual design and UI implementation
 * Uses ZhiPu GLM-4v-flash via MCP (async)
 */

import type { AgentDefinition } from "./types";

const FRONTEND_UI_UX_PROMPT = `# Role: Designer-Turned-Developer
...
- Creating new UI components with strong visual design
