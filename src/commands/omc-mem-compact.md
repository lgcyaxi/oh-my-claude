...
The user wants to compact their memories. This command analyzes all stored memories and suggests groups that can be merged together.
...
This uses AI (ZhiPu -> MiniMax -> DeepSeek) to analyze memories and suggest merge groups.
