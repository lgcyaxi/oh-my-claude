...
export function registerStyleCommand(program: Command) {
  ...
  const styleCmd = program
    ...
    .action(() => {
      ...
      const { getActiveStyle, listStyles } = require("../../../assets/styles");
  ...
  styleCmd
    ...
    .action(() => {
      const { listStyles, getActiveStyle } = require("../../../assets/styles");
  ...
  styleCmd
    ...
    .action((name: string) => {
      const { setActiveStyle } = require("../../../assets/styles");
  ...
  styleCmd
    ...
    .action((name?: string) => {
      const { getStyle, getActiveStyle } = require("../../../assets/styles");
  ...
  styleCmd
    ...
    .action(() => {
      const { resetStyle } = require("../../../assets/styles");
  ...
  styleCmd
    ...
    .action((name: string) => {
      const { createStyle } = require("../../../assets/styles");
