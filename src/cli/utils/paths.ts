...
/** Bridge Bus server script path */
export const BUS_SCRIPT = join(INSTALL_DIR, "dist", "bridge-bus", "server.js");

/** Bridge Bus PID file path */
export const BUS_PID_FILE = join(INSTALL_DIR, "bridge-bus.pid");
