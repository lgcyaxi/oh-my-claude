...
```
Use mcp__oh-my-claude__add_preference with:
- title: <parsed title>
...
```
Use mcp__oh-my-claude__list_preferences with:
...
```
Use mcp__oh-my-claude__get_preference with:
- id: <parsed id>
```
...
```
Use mcp__oh-my-claude__delete_preference with:
...
```
Use mcp__oh-my-claude__update_preference with:
- id: <parsed id>
- autoInject: false
```
