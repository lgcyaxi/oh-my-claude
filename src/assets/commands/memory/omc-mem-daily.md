...
```
Use mcp__oh-my-claude__memory_status to show current session statistics
```
...
```
Use mcp__oh-my-claude__recall with:
- type: "session"
...
```
Use mcp__oh-my-claude__summarize_memories with:
- mode: "analyze"
- type: "session"
- narrative: true
...
- 2026-02-17: "Daily Narrative: 2026-02-17" (merged 3 sessions)
  Tags: coworker opencode polling sidebar
