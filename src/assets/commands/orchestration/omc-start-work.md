...
- **Before starting work**: call `mcp__oh-my-claude__recall` with the plan name and task keywords to retrieve prior context from previous sessions.
- **After completing tasks**: call `mcp__oh-my-claude__remember` to store decisions made, problems solved, and patterns discovered during execution.
