 ...
 */
/** Brand prefix — bold magenta for visibility across themes. Shows "omc[debug]" when OMC_DEBUG=1 */
const BRAND_PREFIX = process.env.OMC_DEBUG === "1"
  ? "\x1b[1;35momc[debug]\x1b[0m"
  : "\x1b[1;35momc\x1b[0m";
