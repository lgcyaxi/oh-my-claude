...
const CACHE_PATH = join(homedir(), ".claude", "oh-my-claude", "cache", "api_usage.json");
 ...
 */
export async function fetchClaudeUsage(timeoutMs = 3000): Promise<UsageResponse | null> {
 ...
 */
export async function pollAndCacheClaudeUsage(timeoutMs = 5000): Promise<boolean> {
