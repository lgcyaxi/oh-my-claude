...
export const proxyToolSchemas: Tool[] = [
  {
    name: "switch_model",
...
Once switched, use /model <name> to switch between any installed Ollama model.`,
    inputSchema: {
      ...
      properties: {
        provider: {
          type: "string",
          description: "Provider name (deepseek, zhipu, minimax, kimi, aliyun, openai, ollama)",
        },
        model: {
          type: "string",
          description: "Model name. Optional for ollama (auto-discovered). Examples: deepseek-reasoner, glm-5, MiniMax-M2.5, kimi-for-coding, qwen3.5-plus, gpt-5.3-codex, llama3.3",
        },
      },
      required: ["provider"],
    },
